...
/**
 `ChartMarker` subclass used in drawing chart tooltips on user touch or drag.
*/
public class RateMarker: ChartMarker {
    ...
    public override func refreshContent(entry entry: ChartDataEntry, highlight: ChartHighlight) {
        ...
        _labelSize = labelns?.sizeWithAttributes(_drawAttributes) ?? CGSize.zero
